...
@prepend(config('formbuilder.layout_js_stack', 'scripts'))
	...
	<script src="{{ asset('vendor/formbuilder/js/script.js') }}{{ dubstepmad\FormBuilder\Helper::bustCache() }}" defer></script>
@endprepend
...
@prepend(config('formbuilder.layout_css_stack', 'scripts'))
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('vendor/formbuilder/css/styles.css') }}{{ dubstepmad\FormBuilder\Helper::bustCache() }}">
