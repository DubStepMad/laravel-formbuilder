                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="visibility" id="visibility" class="form-control" required="required">
                                        ...
                                        @foreach(dubstepmad\FormBuilder\Models\Form::$visibility_options as $option)
...
@push(config('formbuilder.layout_js_stack', 'scripts'))
    ...
    <script src="{{ asset('vendor/formbuilder/js/create-form.js') }}{{ dubstepmad\FormBuilder\Helper::bustCache() }}" defer></script>
@endpush
